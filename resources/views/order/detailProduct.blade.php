    ...
    <table class="table">
        ...
        <tbody class="customtable">
            ...
            <tr>
                ...
                ?>
                <td align='center'><button type="button" onclick="deleteTempProduct({{ $row->id }})" class="btn btn-danger"><i class="fas fa-trash"></i></button></td>
            </tr>
            @endforeach
            @else
        ...
        <tfoot>
            <tr>
                ...
                <td align='center' class="sub_product" data-total="<?= $grandTotal ?>">{{ __('Rp. ') }}@price($grandTotal)</td>
                <td></td>
            </tr>
        </tfoot>
    </table>
