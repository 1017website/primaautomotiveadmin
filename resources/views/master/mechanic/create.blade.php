                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="id_finger" name="id_finger" value="{{ old('id_finger') }}" placeholder="Id Absen Finger">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="positional_allowance" name="positional_allowance" value="{{ old('positional_allowance') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="healthy_allowance" name="healthy_allowance" value="{{ old('healthy_allowance') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="other_allowance" name="other_allowance" value="{{ old('other_allowance') }}" required>
                                </div>
                            </div>
