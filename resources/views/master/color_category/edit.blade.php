<x-app-layout>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('color-category.index') }}">{{ __('Color
                                    Category') }}</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                <h5 class="card-title">{{ __('Edit Color Category') }}</h5>
                ...
                <form class="form-horizontal" action="{{ route('color-category.update', $ColorCategory->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input value="{{ $ColorCategory->name }}" type="text" class="form-control" id="name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="cost" name="cost"
                                value="{{ $ColorCategory->cost }}" placeholder="" required="true" step="0.01">
                        </div>
                    </div>
