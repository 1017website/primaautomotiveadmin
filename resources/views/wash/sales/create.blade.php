    ...
    <div class="container-fluid">
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('wash-sale.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <fieldset class="border p-2">
                                <legend style="font-size: 15px; font-style: italic" class="w-auto">{{ __('Customer') }}
                                </legend>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            <label for="cust_name"
                                                class="col-sm-2 text-left control-label col-form-label">{{ __('Name')
                                                }}</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="cust_name" name="cust_name"
                                                    value="{{ old('cust_name') }}" required="true">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="cust_phone"
                                                class="col-sm-2 text-left control-label col-form-label">{{ __('Phone')
                                                }}</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control phone" id="cust_phone"
                                                    name="cust_phone" value="{{ old('cust_phone') }}" required="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group row hidden">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="cust_id_card"
                                        ...
                                        <div class="form-group row">
                                            <label for="cust_address"
                                                class="col-sm-2 text-left control-label col-form-label">{{ __('Address')
                                                }}</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="cust_address"
                                                    name="cust_address" value="{{ old('cust_address') }}">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <fieldset class="border p-2">
                                <legend style="font-size: 15px; font-style: italic" class="w-auto">{{ __('Car') }}
                                </legend>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="select2 form-control custom-select" id="cars_id"
                                                    name="cars_id" style="width: 100%;">
                                                    @foreach($car as $row)
                                                    <option value="{{$row->id}}">{{ $row->type->name }} - {{
                                                        $row->brand->name }} - {{$row->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-group row">
                                            <label for="vehicle_plate"
                                                class="col-sm-2 text-left control-label col-form-label">{{ __('Plate')
                                                }}</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="vehicle_plate"
                                                    name="vehicle_plate" value="{{ old('vehicle_plate') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="vehicle_document"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group row">
                                            <label for="vehicle_year"
                                                class="col-sm-2 text-left control-label col-form-label">{{ __('Year')
                                                }}</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="vehicle_year"
                                                    name="vehicle_year" value="{{ old('vehicle_year') }}">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <label for="vehicle_color"
                                                class="col-sm-2 text-left control-label col-form-label">{{ __('Color')
                                                }}</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="vehicle_color"
                                                    name="vehicle_color" value="{{ old('vehicle_color') }}">
                                            </div>
                                        </div>
                            ...
                            <fieldset class="border p-2">
                                <legend style="font-size: 15px; font-style: italic" class="w-auto">{{ __('List Service')
                                    }}</legend>
                                <button type="button" class="btn btn-default btn-action mt-2 mb-2" data-toggle="modal"
                                    data-target="#Modal2">{{ __('Add Service') }}</button>
                                <div class="detail">
                            ...
                            <fieldset class="border p-2">
                                <legend style="font-size: 15px; font-style: italic" class="w-auto">{{ __('List Product')
                                    }}</legend>
                                <button type="button" class="btn btn-default btn-action mt-2 mb-2" data-toggle="modal"
                                    data-target="#Modal3">{{ __('Add Product') }}</button>
                            ...
                            <div class="form-group row">
                                ...
                                <label for="disc_persen_header"
                                    class="col-sm-1 text-left control-label col-form-label">{{ __('Disc') }}</label>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-8"></div>
                                <label for="disc_persen_header"
                                    class="col-sm-1 text-left control-label col-form-label">{{ __('PPn') }}</label>
                                <div class="col-sm-1">
                                    <input type="text" class="form-control" id="ppn_persen_header"
                                        name="ppn_persen_header" value="{{ old('ppn_persen_header') }}"
                                        style="align:right" placeholder="%">
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-8"></div>
                                <label for="grand_total" class="col-sm-1 text-left control-label col-form-label">{{
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="service_id" class="col-sm-2 text-left control-label col-form-label">{{ __('Service')
                            }}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="service_qty" class="col-sm-2 text-left control-label col-form-label">{{ __('Qty')
                            }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="service_qty" name="service_qty" required="true"
                                value="1">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="qty" class="col-sm-2 text-left control-label col-form-label">{{ __('Price')
                            }}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="disc_persen" class="col-sm-2 text-left control-label col-form-label">{{ __('Disc')
                            }}</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group row" style="display:none;">
                        <label for="service_disc" class="col-sm-2 text-left control-label col-form-label">{{ __('Disc')
                            }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="service_disc" name="service_disc"
                                placeholder="">
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="product_id" class="col-sm-2 text-left control-label col-form-label">{{ __('Product')
                            }}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="product_qty" class="col-sm-2 text-left control-label col-form-label">{{ __('Qty')
                            }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="product_qty" name="product_qty" required="true"
                                value="1">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="price_product" class="col-sm-2 text-left control-label col-form-label">{{
                            __('Price') }}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="disc_persen_product" class="col-sm-2 text-left control-label col-form-label">{{
                            __('Disc') }}</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="disc_persen_product" name="disc_persen_product"
                                placeholder="">
                        </div>
                        <div class="col-sm-1" style="line-height: 35px;"><span class="align-middle">%</span></div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="type_car_id" class="col-sm-2 text-left control-label col-form-label">{{ __('Type')
                            }}</label>
                        <div class="col-sm-10">
                            <select class="select2 form-control custom-select" id="type_car_id" name="type_car_id"
                                style="width: 100%;">
                    ...
                    <div class="form-group row">
                        <label for="brand_car_id" class="col-sm-2 text-left control-label col-form-label">{{ __('Type')
                            }}</label>
                        <div class="col-sm-10">
                            <select class="select2 form-control custom-select" id="brand_car_id" name="type_car_id"
                                style="width: 100%;">
                    ...
                    <div class="form-group row">
                        <label for="name_car_id" class="col-sm-2 text-left control-label col-form-label">{{ __('Name')
                            }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="name_car_id" name="name_car_id" required="true"
                                value="">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="year_car_id" class="col-sm-2 text-left control-label col-form-label">{{ __('Year')
                            }}</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="year_car_id" name="year_car_id" required="true"
                                value="">
                        </div>
                    </div>
