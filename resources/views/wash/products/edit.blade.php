    ...
    <div class="container-fluid">
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('wash-product.update', $washProduct->id) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input value="{{ $washProduct->name }}" type="text" class="form-control" id="name"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="buying_price" name="buying_price"
                                value="{{ $washProduct->buying_price }}" placeholder="" required="true">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="selling_price" name="selling_price"
                                value="{{ $washProduct->selling_price }}" placeholder="" required="true">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="stock" class="col-sm-2 text-left control-label col-form-label">{{ __('Stock')
                            }}</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="stock" name="stock"
                                value="{{ $washProduct->stock }}" placeholder="" required="true">
                        </div>
                    </div>
