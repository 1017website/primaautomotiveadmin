<x-app-layout>
            ...
            <div class="col-12 d-flex no-block align-items-center">
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('wash-expense-service.index') }}">{{ __('Service Spending') }}</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="div-top">
            <a class="btn btn-default" href="{{ route('wash-expense-service.index') }}">{{ __('Back') }}</a>
        </div>

        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                <h5 class="card-title">{{ __('Add Service Spending') }}</h5>
                ...
                <form class="form-horizontal" action="{{ route('wash-expense-service.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class ="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input value="{{ old('price') }}" type="text" class="form-control" id="price" name="price" required="true">
                                        </div>
                                    </div>
