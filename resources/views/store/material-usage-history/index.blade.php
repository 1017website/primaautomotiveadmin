<x-app-layout>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Material Usage History') }}
                            </li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                <h5 class="card-title">{{ __('Material Usage History') }}</h5>
                ...
                <div class="filter">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3 input-group">
                            <input type="text" class="form-control mydatepicker" id="date_1" name="date_1" value=""
                        ...
                        <div class="col-sm-3 input-group">
                            <input type="text" class="form-control mydatepicker" id="date_2" name="date_2" value=""
                                placeholder="dd/mm/yyyy" autocomplete="off">
                            <div class="input-group-append">
                                <span class="input-group-text form-control"><i class="fa fa-calendar"></i></span>
                            </div>
                    ...
                    <!--type item-->
                    <div class="form-group row">
                        <label for="type_item" class="col-sm-2 text-left control-label col-form-label">{{ __('Type
                            Item') }}</label>
                        <div class="col-sm-3">
                            <select class="select2 form-control custom-select" id="id_type_product"
                                name="id_type_product" style="width: 100%;">
    ...
    <script>
        $("#search").click(function () {
            $.ajax({
                url: "{{ route('historyMaterialUsage') }}",
                type: 'GET',
                dataType: 'json',
                data: {
                    'date_1': $('#date_1').val(),
                    'date_2': $('#date_2').val(),
                    'id_type_product': $('#id_type_product').val()
                },
