<x-app-layout>
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('History Mixing Stock') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card bg-white shadow default-border-radius">
            <div class="card-body">
                <h5 class="card-title">{{ __('Current Mixing Stock') }}</h5>
    ...
    <script>
        $("#search").click(function () {
            $.ajax({
                url: "{{ route('historyStockRackView') }}",
                type: 'GET',
                dataType: 'json',
                data: {
                    'date_1': $('#date_1').val(),
